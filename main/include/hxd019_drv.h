...
#include 	"DataType.h"
//printf("%s IRDA_SDA_PIN %d\r\n", method, (1 == gpio_get_level(IRDA_SDA_PIN)))
#define sda_print(method)
//printf("%s IRDA_SCL_PIN %d\r\n", method, (1 == gpio_get_level(IRDA_SCL_PIN)))
#define scl_print(method)
//printf("line:%d\terror:%d\r\n", __LINE__, error)
//printf("%d->%d,", __LINE__, error)
#define error_print(error) IRDA_delay_1ms(1)
